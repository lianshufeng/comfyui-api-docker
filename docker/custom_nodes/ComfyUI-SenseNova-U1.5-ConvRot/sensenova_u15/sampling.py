...
def resolution_noise_scale(height, width, base_seq_len=64, noise_scale=1.0, maximum=16.0):
...
class SenseNovaModelSampling(comfy.model_sampling.ModelSamplingDiscreteFlow, comfy.model_sampling.CONST):
